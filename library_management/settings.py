...
# SECRET_KEY = 'django-insecure-)z34l4d^90tonti9*m+a6!ag$h01f0p_90ifvjtc7r&ow!j4bf'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["*"]
CSRF_TRUSTED_ORIGINS = ['https://library-management-fdta.onrender.com','https://*.127.0.0.1']
